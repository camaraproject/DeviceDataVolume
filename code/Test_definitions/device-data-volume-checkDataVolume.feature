Feature: CAMARA Device Data Volume API, v0.1.0-rc.1 - Operation checkDataVolume
  ...
  Background: Common checkDataVolume setup
    Given the resource "{apiRoot}/device-data-volume/v0.1rc1/check" set as base-url
