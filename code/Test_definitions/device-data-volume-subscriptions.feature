...
Feature: Device Data Volume Subscriptions API, v0.2.0-rc.1 - Operations createDeviceDataVolumeSubscription, retrieveDeviceDataVolumeSubscription, deleteDeviceDataVolumeSubscription
  ...
  Background: Common Device Data Volume Subscription setup
    ...
    And the resource "/device-data-volume-subscriptions/v0.2rc1/subscriptions"
